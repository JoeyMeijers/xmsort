...
run-xs-params:
	go run ./cmd/xmsort "I=test_data.txt" "O=out.txt" "RL=122" "RT=V" "s1=(e=0,l=2,g=ebcdic,v=a)" "s2=(e=2,l=2,g=ebcdic,v=d)" "s3=(e=5,l=10,g=ascii,v=a)" "s4=(e=15,l=65,g=ascii,v=d)"
